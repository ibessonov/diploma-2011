...
/*
 *  Класс StringSubDelFrom реализует функцию стр Удал_от(стр СТРОКА,цел ИНДЕКС),
 *  которая возвращает новую строку, полученную из строки СТРОКА и
 *  не содержащую подстроку, начинающуюся с позиции ИНДЕКС.
 *  @author Полевая Евгения
 */

public class StringSubDelFrom extends ExternalFunction {
